...
# init elasticsearch.yml
if [ -z $(grep 'node.name' /usr/share/elasticsearch/config/elasticsearch.yml) ]
then
	echo "node.name: ${HOSTNAME}" >> /usr/share/elasticsearch/config/elasticsearch.yml
fi
